...
FileDir = {};
FileDir["VMA_H"] = "%{wks.location}/Hydra/vendor/vma/vk_mem_alloc.h"
FileDir["VMA_CPP"] = "%{wks.location}/Hydra/vendor/vma/vk_mem_alloc.cpp"
...
FileDir["TINYDDS"] = "%{wks.location}/Hydra/vendor/tinydds/**.h"
